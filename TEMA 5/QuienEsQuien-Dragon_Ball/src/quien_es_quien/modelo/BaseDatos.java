...
public class BaseDatos {
    ...
    public static List<Personaje> getPersonajes() {
        ...
        // Datos de personaje:
        // Nombre, Imagen, Saiyan, Villano, Pelo, Verde, Androide, Terricola, Dios
        ...
        lista.add(new Personaje("Piccolo Daimao", "piccolo_daimao.png", false, true, false, true, false, false, false));

        // Dragon Ball Z
        lista.add(new Personaje("Piccolo", "piccolo.png", false, false, false, true, false, false, false));
        lista.add(new Personaje("Vegeta", "vegeta.png", true, false, true, false, false, false, false));
        ...
        // Dragon Ball Super
        lista.add(new Personaje("Beerus", "beerus.png", false, false, false, false, false, false, true));
        lista.add(new Personaje("Whis", "whis.png", false, false, true, false, false, false, true));
        lista.add(new Personaje("Goku Black", "goku_black.png", true, true, true, false, false, false, true));
        lista.add(new Personaje("Jiren", "jiren.png", false, true, false, false, false, false, false));
        lista.add(new Personaje("Broly (Super)", "broly.png", true, false, true, false, false, false, false));
